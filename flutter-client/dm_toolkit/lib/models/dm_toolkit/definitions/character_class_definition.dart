...
class CharacterClassDefinition implements IDefinition {
  ...
  final bool primaryAbilityScoreIsExclusive;
  final int hitDie;
  final List<AbilityScoreDefinition> savingThrowProficiencies;
  final List<SkillDefinition> skillProficiencies;
  final int numberOfSkillProficiencies;
  final List<WeaponCategory> weaponProficiencies;
  final List<String> extraWeaponProficiencies;
  final ToolDefinition? toolProficiency;
  final List<ToolCategory> toolProficiencyCategories;
  final int numberOfToolProficiencies;
  final List<ArmorCategory> armorProficiencies;
  final List<ItemDefinitionBaseQuantity> startingEquipmentQuantityTables;
  final int startingGp;
  final List<FeatGroupLevel> featTables;
  final List<SubclassDefinition> subclassDefinitions;
  final List<int> numberOfPreparedSpells;
  final List<int> numberOfCantrips;
  final List<int> levelOneSlots;
  final List<int> levelTwoSlots;
  final List<int> levelThreeSlots;
  final List<int> levelFourSlots;
  final List<int> levelFiveSlots;
  final List<int> levelSixSlots;
  final List<int> levelSevenSlots;
  final List<int> levelEightSlots;
  final List<int> levelNineSlots;
  final AbilityScoreDefinition? spellcastingAbility;
  final ItemDefinitionBase? spellcastingFocus;
  final bool hasSpellbook;
  final List<int> classPoints;
  final List<int> classDieNumber;
  final List<int> classDieSides;
  final List<int> weaponMasteries;
  final List<int> classBonus;
  final int defaultStr;
  final int defaultDex;
  final int defaultCon;
  final int defaultInt;
  final int defaultWis;
  final int defaultCha;
  final int fixedHp;
  final bool multiGetsMartialProficiency;
  final List<ArmorCategory> multiGetsArmorProficiency;
  final bool multiGetsSkillProficiency;
  final bool multiGetsAToolProficiency;
  final ToolCategory multiToolProficiencyCategory;
  final int multiSpellSlotDenominator;
