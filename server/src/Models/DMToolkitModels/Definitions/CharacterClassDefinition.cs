...
public class CharacterClassDefinition : IDefinition
{
    ...
    public ICollection<CharacterClassDefinitionItemDefinitionBase> CharacterClassDefinitionItemBases { get; set; } = new List<CharacterClassDefinitionItemDefinitionBase>();
