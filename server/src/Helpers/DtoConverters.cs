...
public static class DtoConverters
{
    ...
    private static CharacterClassDefinitionDto ConvertCharacterClassDefinition(CharacterClassDefinition characterClass)
    {
        return new()
        {
            ...
            PrimaryAbilityScoreDefinitionId = characterClass.PrimaryAbilityScoreDefinitionId,
            AlternativePrimaryAbilityScoreDefinitionId = characterClass.AlternativePrimaryAbilityScoreDefinitionId,
            PrimaryScoreIsExclusive = characterClass.PrimaryScoreIsExclusive,
